...
public class RequestServiceImpl implements RequestService {
    ...
    @Override
    public List<RequestDetailsDTO> getAllRequests(Long ldUserId, String status, String departmentName, String eventName, String requestorName, LocalDate fromDate, LocalDate toDate) throws UnauthorizedActionException {
    ...
    @Override
    public RequestCountsDTO getAllRequestsSummaryCounts(Long requestorId) throws UnauthorizedActionException {
        ...
        Long approved = requestRepository.countByRequestStatus("APPROVED");
    ...
    @Override
    public RequestDetailsDTO getRequestDetails(Long requestId) throws RequestNotFoundException {
    ...
    public RequestDetailsDTO createRequest(CreateRequestDTO createRequestDTO) {
        ...
        if (createRequestDTO.getParticipantUserIds() != null && !createRequestDTO.getParticipantUserIds().isEmpty()) {
            ...
            newRequest.setNoOfParticipants(0L);
    ...
    @Override
    @Transactional
    public Request updateRequest(Long requestId, EditRequestDTO editRequestDTO) throws RequestNotFoundException {
        ...
        Iterator<UserInfo> iterator = existingRequest.getRequestedParticipants().iterator();
